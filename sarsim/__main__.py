...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        dest="do",
        help="run the script file(s) specified. See --help-scripting",
    )
    parser.add_argument(
        "--do", action="extend", nargs="+", help="run the script command specified. See --help-scripting"
    )
    ...
    state = commands.ProgramState(args=args, simstate=simstate.create_state(), scene=simscene.create_default_scene())
